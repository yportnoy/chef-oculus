...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :centos6 do |centos6|
    ...
    centos6.vm.hostname = 'oculus-centos-6'
  ...
  config.vm.define :ubuntu1204 do |ubuntu1204|
    ...
    ubuntu1204.vm.hostname = 'oculus-ubuntu-1204'
  ...
  config.vm.define :ubuntu1210 do |ubuntu1210|
    ...
    ubuntu1210.vm.hostname = 'oculus-ubuntu-1210'
  ...
  config.vm.define :ubuntu1304 do |ubuntu1304|
    ...
    ubuntu1304.vm.hostname = 'oculus-ubuntu-1304'
